...
const allProjects: ProjectCardProps[] = [
  {
    ...
    name: 'Fina App',
    type: 'Mobile App',
    description: 'Streamline the orders from clients, with a mobile app that allow a follow-up of all the process all on any device.',
    links: '/blog/fina-mobile-app',
    imgs: {
      webp: '/WebDev.webp',
      jpg: 'WebDev.jpg',
...
function ProjectsSection() {
  return (
    ...
    <section className="flex flex-col items-center md:flex-row xl:flex-row gap-2 justify-center  md:justify-between lg:justify-between xl:justify-evenly">
