...
function page() {
  return (
    ...
    <div className="text-black xsm:gap-4 sm:gap-4 flex flex-col gap-4 items-center xsm:flex-col sm:flex-col md:flex-row md:justify-evenly md:gap-2 sm:items-center">
      <section className="bg-gray-300 px-2 py-3 w-80 rounded  shadow-md">
      ...
      <section className="bg-gray-300 px-2 py-1 w-80 rounded  shadow-md">
        <div className="flex flex-row gap-2 justify-center items-center">
